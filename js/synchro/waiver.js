...
$j("#project_publish_link").click(function() {
	if(validateForm())
	{
		dialog({
				title: 'Message',
				html: '<p>Are you sure you want to Create a waiver? You will not be able to change these details later.</p>',
				buttons:{
					"Yes":function() {
...
$j("#project_cancel_link").click(function() {
	...
	dialog({
			title: 'Message',
			html: '<p>Are you sure you want to cancel waiver? Your changes will not be saved.</p>',
			buttons:{
				"Yes":function() {
					window.location.href = '/synchro/waiver-catalogue.jspa';
				},
				"No": function() {
					closeDialog();						
				}
...
if(validateApproverComments())
{
	dialog({
            title: 'Message',
            html: '<p>Are you sure you want to Approve?</p>',
            buttons:{
                "Yes":function() {
					showLoader('Please wait...');
                    var form = $j("#form-create");
...
if(validateApproverComments())
{
	dialog({
            title: 'Message',
            html: '<p>Are you sure you want to Reject?</p>',
            buttons:{
                "Yes":function() {
					showLoader('Please wait...');
                    var form = $j("#form-create");
