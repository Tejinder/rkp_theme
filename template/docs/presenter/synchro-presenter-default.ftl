    ...
    <header>
        ...
        <div class="j-byline font-color-meta">
            ...
            <div class="j-version j-rc4">
                ...
                <#-- BEGIN SYNCHRO - Changes for making the version difference link compatible with Synchro -->
                <#--<a href="<@s.url value='/synchro/docs/${document.documentID}/diff?secondVersionNumber=${document.documentVersion.versionNumber?c}'/>">-->
