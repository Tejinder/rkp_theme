...
<form id="folder-delete-form" action="/oracle/oracle-folder-dashboard!delete.jspa" method="POST" class="result-form-popup ">
...
function processPaginationRequest(page, keyword, plimit) {
	...
	var url = '/oracle/oracle-folder-dashboard-pagination.jspa';
