...
<div class="project_dashboard_table_left">
    <table id="project_logs_table_body" class="scrollable-table project_status_table tablesorter">
        <thead>
		<th class="project-log-activity sortable"><span span id="type">Activity Type</span></th>
        <th class="project-log-description"><span>Activity Description</span></th>
		<th class="project-log-username sortable"><span id="userName">Username</span></th>
		<th class="project-log-timestamp sortable"><span id="timestamp">Timestamp</span></th>        
        </thead>
        <tbody>
            <#list logs as log>		
			...
			<#list log.descriptions as description>						
				<tr id="log-${log_index}-${description_index}" <#if !showRow>style="display:none;"</#if><#if (log_index % 2) == 0> class="last"</#if>>
					<td class="project-log-activity">
					  <span><#if description_index==0>${log.activity}</#if></span>
					</td>
					<td class="project-log-description">
					...
					<td class="project-log-timestamp">
