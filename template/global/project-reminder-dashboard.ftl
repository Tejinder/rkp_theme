...
<script type="text/javascript">
    ...
    function processPaginationRequest(page, keyword) {
        ...
        var url = "<@s.url value='/synchro/project-reminders-pagination.jspa'/>";
    ...
    function showSetReminderPopup(id) {
        ...
        clearErrorMessage();
        var div = $j('<div id="project-reminder-popup" class="synchro-reminder-popup project-reminder-popup"></div>');
        ...
        showLoader();
        var url = "<@s.url value='/synchro/project-reminder!input.jspa'/>";
        ...
        $j(div).lightbox_me({centered:true,closeEsc:false,closeClick:false,overlayCSS:{background: 'black', opacity: .7},destroyOnClose:true,onLoad:function(){
            ...
            $j(subdiv).load(url,{},function(){
                ...
                clearErrorMessage();
                hideLoader();
                origPoupHeight = $j("#project-reminder-form").height();
                resizePopup();
    ...
    function resizePopup() {
        ...
        var popupHeight = $j("#project-reminder-popup").height();
        ...
        if((popupHeight + 150) > bodyHeight) {
            ...
            var topPos = $j("#project-reminder-popup").offset().top;
            if(topPos > 45) {
                $j("#project-reminder-popup").css("top", (topPos - 37) + "px");
            }
            $j("body").scrollTop();
        }
        else {
        ...
        $j("#project-reminder-popup").trigger("resize");
        $j("body").scrollTop();
    }

    function closeProjectReminderPopup() {
        $j("#project-reminder-popup").trigger("close");
    }

</script>
<div class="container-sub  synchro-reminders">
    <div class="project_view">
        <div class="project_dashboard_header">
            <h3>My Reminders</h3>
            <div class="report-menus" xmlns="http://www.w3.org/1999/html">
                <ul class="project_name_menu">
                    <li><a href="<@s.url value='/synchro/project-reminders!input.jspa'/>" class="active">Project Reminder Alerts</a></li>
                    <li><a href="<@s.url value='/synchro/general-reminders!input.jspa'/>">General Reminder Alerts</a></li>
                </ul>
            </div>
...
<script type="text/javascript">	
<!-- Audit Logs -->
	<#assign i18CustomText><@s.text name="logger.reminder.view.project" /></#assign>
