...
<div class="container-sub">
    ...
    <div class="project_view">
		...
		<div class="dashboard-filter-links">
			<a href="javascript:void(0);" class="active">Open Projects</a>
			<a href="/new-synchro/global-dashboard-close.jspa">Closed Projects</a>
			<a href="/new-synchro/global-dashboard.jspa" >All Projects</a>
		</div>
...
//        $j("#ascendingOrder").val("");
    ...
    {
        currPage = page;
        var url = '/new-synchro/global-dashboard-open-pagination.jspa'
        if(xhr != null)
            xhr.abort();
...
function processDownloadRequest(page, keyword, plimit, downloadReportType) {
	...
	$j("#result-filter-form").prop("action", "/new-synchro/global-dashboard-open-pagination!downloadReport.jspa");
	var filterForm = $j("#result-filter-form");
...
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText>Global Open Projects</#assign>
