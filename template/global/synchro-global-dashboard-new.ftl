...
<div class="container-sub">
    ...
    <div class="project_view">
            ...
            <div class="report-menus" xmlns="http://www.w3.org/1999/html">
                <ul class="project_name_menu">
					...
					<#if statics['com.grail.synchro.util.SynchroPermHelper'].isSynchroAdmin(user) || statics['com.grail.synchro.util.SynchroPermHelper'].isGlobalUserType() || statics['com.grail.synchro.util.SynchroPermHelper'].isLegaUserType() || statics['com.grail.synchro.util.SynchroPermHelper'].isSynchroSystemOwner()>
						<li><a href="<@s.url value='/new-synchro/global-dashboard-open.jspa'/>"  class="active">Global Projects</a></li></#if>
		...
		<div class="dashboard-filter-links">
			<a href="/new-synchro/global-dashboard-open.jspa" >Open Projects</a>
			<a href="/new-synchro/global-dashboard-close.jspa">Closed Projects</a>
			<a href="javascript:void(0);" class="active">All Projects</a>
		</div>
...
//        $j("#ascendingOrder").val("");
    ...
    {
        currPage = page;
        var url = '/new-synchro/global-dashboard-pagination.jspa'
        if(xhr != null)
            xhr.abort();
...
function processDownloadRequest(page, keyword, plimit, downloadReportType) {
	...
	$j("#userTimezone").val(Intl.DateTimeFormat().resolvedOptions().timeZone);	
	
	$j("#result-filter-form").prop("action", "/new-synchro/global-dashboard-pagination!downloadReport.jspa");
	var filterForm = $j("#result-filter-form");
...
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText>Global All Projects</#assign>
