...
<div >
    <div id="synchro-success-box-approved" class="jive-success-box">
        ...
        <div class="success-msg">
           ...
           <#-- <div class="my-dashboard-link"><a href="<@s.url value='/new-synchro/waiver-catalogue.jspa'/>">View My Waiver</a></div>-->
		   <div class="my-dashboard-link"><a href="<@s.url value='/new-synchro/process-waiver-dashboard.jspa'/>">View My Waiver</a></div>
