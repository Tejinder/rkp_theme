          ...
          -->
            ...
            <div class="report-menus" xmlns="http://www.w3.org/1999/html">
                <ul class="project_name_menu">
                    <li><a href="<@s.url value='/synchro/dashboard.jspa'/>" >All Projects</a></li>
                    <li><a href="<@s.url value='/synchro/draft-dashboard.jspa'/>" class="active">Draft Projects</a></li>
                </ul>
            </div>
...
//        $j("#ascendingOrder").val("");
    ...
    {
        currPage = page;
        var url = '/synchro/dashboard-draft-pagination.jspa'
        if(xhr != null)
            xhr.abort();
