    ...
    <div class="waiver-catalogue project_view">
        <div class="project_dashboard_header">
			...
			<#if initiateWaiver?? && initiateWaiver>
				<a href="<@s.url value="/new-synchro/create-waiver!input.jspa"/>" class="initiate-waiver"><@s.text name="waiver.initiate.button.label"/></a>
			</#if>
...
function processPaginationRequest(page, keyword) {
	...
	var url = '/new-synchro/waiver-catalogue-pagination.jspa';
