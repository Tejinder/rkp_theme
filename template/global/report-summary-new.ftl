...
$j(document).ready(function(){
   ...
   /* PROJECT_STAGE_NAVIGATOR.initialize({
    ...
    FORM_DATA_PERSIST_HANDLER.handle({parentForm:$j("#report-summary-form"),form:$j("#email-notification-form"), projectID:${projectID?c}});
...
<#--	FORM_DATA_PERSIST_HANDLER.handle({parentForm:$j("#report-summary-form"),form:$j("#synchro-pit-form"), projectID:${projectID?c}}) -->
...
{
    FORM_DATA_PERSIST_HANDLER.handle({parentForm:$j("#report-summary-form"),form:$j("#waiver-form"), projectID:${projectID?c}});
...
<#if !canEditStage>	
	<#include "/template/global/report-summary-new-readOnly.ftl" />
<#else>
...
<div class="table report-summary-table">
	...
	<#if reportSummaryDetailsList?? && reportSummaryDetailsList?size gt 0 >
		...
		<#list reportSummaryDetailsList as reportSummaryDetails>
			...
			<div class="tr" id="mainReportTypeDiv">
				...
				<#else>
					...
					<#if  reportTypeCounter gt 1>
						<select name="reportTypes"  onchange="validateReportType();" id="reportType" data-placeholder="Select Report Type" class="chosen-select form-select  report-type-attach rt">
					...
					<option value="3" <#if reportSummaryDetails.getReportType()==statics['com.grail.synchro.SynchroGlobal$ReportType'].EXECUTIVE_PRESENTATION.getId()> selected </#if>>Executive Summary</option>
					
					</select>
					
					<span class="jive-error-message full-width" id="reportTyperError" style="display:none">Please select Report Type</span>
					<span class="jive-error-message full-width" id="reportTypesErrors" style="display:none">Please select Report Type</span>
					
				</div>
			       
				<div class="td" id="legalApproverDiv">
					<#if  reportTypeCounter gt 1>
						<input type="text" name="reportTypeLegalApprovers" onchange="validateReportLegalApprovers();" placeholder="Enter Legal Approver's Name" value="${reportTypeLegalApproverName}" onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
						<span class="jive-error-message full-width" id="reportTypeLegalApproverErrors" style="display:none">Please enter Legal Approver's Name</span>
					<#else>
						<input type="text" name="reportTypeLegalApprover" id="reportTypeLegalApprover" placeholder="Enter Legal Approver's Name" value="${reportTypeLegalApproverName}" onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
						<span class="jive-error-message full-width" id="reportTypeLegalApproverError" style="display:none">Please enter Legal Approver's Name</span>
					</#if>
					...
					<div class="td" id="attachmentDiv"><span class="jive-icon-med jive-icon-attachment j-link" onclick="showAttachmentPopupNewReport(${fullReportID?c},this,${reportSummaryDetails.getReportOrderId()})" ></span>
				        ...
				        <span class="jive-error-message full-width" id="attachmentError" style="display:none">Please attach the Report</span>
		...
		<div class="tr" id="mainIrisSummaryTypeDiv">
			...
			<#if  irisCounter gt 1>
				...
				<div class="td"><input type="text" name="irisSummaryLegalApprovers"  onchange="validateIrisSummaryLegalApprovers();"  id="irisSummaryLegalApprover" placeholder="Enter Legal Approver's Name" value="${irisLegalApproverName}" onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/> <span class="jive-error-message full-width" id="irisSummaryLegalApproverErrors" style="display:none">Please enter Legal Approver's Name</span> </div>
			<#else>
				<div class="td"><input type="button" value="duplicate" class="duplicate add-icon" id="mainIrisSummaryType"><span>IRIS Summary</span> <div class="download-link-wrapper"><div class="standard-report-download-link" >
				
				  <a href='${JiveGlobals.getJiveProperty("synchro.iris.summary.template.path","/file/download/IRIS-Summary-Template_09.11.2018.xlsm")}'>Download Template for IRIS Summary</a>
			 </div></div></div>
			
				<div class="td">
				<input type="text" name="irisSummaryLegalApprover" id="irisSummaryLegalApprover" placeholder="Enter Legal Approver's Name" value="${irisLegalApproverName}" onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
				<span class="jive-error-message full-width" id="irisSummaryLegalApproverError" style="display:none">Please enter Legal Approver's Name</span>
				</div>
			</#if>
			...
			<div class="td"><span class="jive-icon-med jive-icon-attachment j-link" onclick="showAttachmentPopupNew(${irisSummaryReportID?c},${reportSummaryDetails.getReportType()},${reportSummaryDetails.getReportOrderId()})" ></span>
				...
				<span class="jive-error-message full-width" id="attachmentError" style="display:none">Please attach the IRIS Summary</span>
			</div>
		</div>
		</#if>
		...
		<div class="tr" id="mainTPDSummaryTypeDiv">
			...
			<#if tpdCounter gt 1>
				...
				<div class="td"><input type="text" onchange="tpdSummaryLegalApproversValidation();" name="tpdSummaryLegalApprovers" id="tpdSummaryLegalApprover" placeholder="Enter Legal Approver's Name" value="${tpdLegalApproverName}" onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
				<span class="jive-error-message full-width" id="tpdSummaryLegalApproverErrors" style="display:none">Please enter Legal Approver's Name</span>
				
				
			<#else>
				<div class="td"><input type="button" value="duplicate" class="duplicate add-icon" id="mainTPDSummaryType"><span>TPD Summary</span> </div>
				<div class="td"><input type="text" name="tpdSummaryLegalApprover" id="tpdSummaryLegalApprover" placeholder="Enter Legal Approver's Name" value="${tpdLegalApproverName}"    onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
				<span class="jive-error-message full-width" id="tpdSummaryLegalApproverError" style="display:none">Please enter Legal Approver's Name</span>
			</#if>	
			<div>
			...
			<#if tpdCounter gt 1 >
				...
				<span class="jive-error-message full-width" id="tpdSummaryDateErrors" style="display:none">Please enter Legal Approver's Date</span>
			...
			<span class="jive-error-message full-width" id="tpdSummaryDateError" style="display:none">Please enter Legal Approver's Date</span>
			
			</div>
			</div>
			<div class="td tpd"><span class="jive-icon-med jive-icon-attachment j-link" onclick="showAttachmentPopupNew(${tpdSummaryReportID?c},${reportSummaryDetails.getReportType()},${reportSummaryDetails.getReportOrderId()})" ></span>
	...
	<#else>	
		<div class="tr" id="mainReportTypeDiv">
			<div class="td"><input type="button" value="duplicate" class="duplicate add-icon" id="mainReportType">
				<select name="reportType" id="reportType" data-placeholder="Select Report Type" class="chosen-select form-select report-type-attach" >
				
				<option value=""></option>
				<option value="1">Full Report</option>
				<option value="2">Top Line Report</option>
				<option value="3">Executive Summary</option>
			...
			<div class="td" id="legalApproverDiv">
				<input type="text" name="reportTypeLegalApprover" id="reportTypeLegalApprover" placeholder="Enter Legal Approver's Name" value="" onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
				<span class="jive-error-message full-width" id="reportTypeLegalApproverError" style="display:none">Please enter Legal Approver's Name</span>
				
			</div>
			<div class="td" id="attachmentDiv"><span class="jive-icon-med jive-icon-attachment j-link" onclick="showAttachmentPopupNewReport(${fullReportID?c},this,1)" ></span>
		...
		<div class="tr" id="mainIrisSummaryTypeDiv">
			...
			<div class="td">
				<input type="text" name="irisSummaryLegalApprover" id="irisSummaryLegalApprover" placeholder="Enter Legal Approver's Name" value="" onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
				<span class="jive-error-message full-width" id="irisSummaryLegalApproverError" style="display:none">Please enter Legal Approver's Name</span>
			</div>
			<div class="td"><span class="jive-icon-med jive-icon-attachment j-link" onclick="showAttachmentPopupNew(${irisSummaryReportID?c},4,2)" ></span>
		...
		<#else>
			...
			<div class="td"><input type="button" value="duplicate" class="duplicate add-icon" id="mainTPDSummaryType"><span>TPD Summary</span></div>
			 <div class="td"><input type="text" placeholder="Enter Legal Approver's Name" name="tpdSummaryLegalApprover" id="tpdSummaryLegalApprover" value=""   onfocus="this.placeholder = '' " onblur="this.placeholder = 'Enter Legal Approver's Name' "/>
			<span class="jive-error-message full-width" id="tpdSummaryLegalApproverError" style="display:none">Please enter Legal Approver's Name</span>
			<div><@synchrodatetimepicker id="tpdSummaryDate" name="tpdSummaryDate" value="" format="%d/%m/%Y" readonly=true disablePrevDates=false defaultDateTimePicker=false placeholder="Enter Date of Legal Approval" tpdDate=true />
			<span class="jive-error-message full-width" id="tpdSummaryDateError" style="display:none">Please enter Legal Approver's Date</span>

			</div>
			</div>
			<div class="td tpd"><span class="jive-icon-med jive-icon-attachment j-link" onclick="showAttachmentPopupNew(${tpdSummaryReportID?c},5,3)" ></span>
	 ...
	 <#if statics['com.grail.synchro.util.SynchroPermHelper'].budgetYearException(projectID) || methException == "yes">
		
		<#if project.processType?? && (project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].END_MARKET_EU_ONLINE.getId() || project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].END_MARKET_EU_OFFLINE.getId() || project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].GLOBAL_EU_ONLINE.getId() || project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].GLOBAL_EU_OFFLINE.getId()) && proposalInitiation?? && proposalInitiation.legalApprovalStatus?? && (proposalInitiation.legalApprovalStatus == 1)>
		
			<div class="legal-checkbox" id="legal-checkbox"><input type="checkbox" name="legalsignoffreq" <#if reportSummaryInitiation?? && reportSummaryInitiation.legalSignOffRequired?? && reportSummaryInitiation.legalSignOffRequired==1> checked="true"</#if>  id="legalsignoffreq" >This project does not require Report/IRIS Summary.</div>
...
<script type="text/javascript">
	...
	function showAttachmentPopupNew(fieldId, reportType, reportOrderId) {
		...
		*/
		...
		// This is for preserving the Legal Signoff check box on adding attachment http://redmine.nvish.com/redmine/issues/509
...
<div class="buttons">
    <#if canEditStage || isAdminUser || isSynchroSystemOwner || isProjectCreator || isSynchroSystemOwner  >
		...
		<a href="javascript:void(0);" style="margin-left: 10px;" onclick="return saveRSForm();" class="publish-details">Save</a>	
	...
	<script>
		$j(document).ready(function() {
			...
			{	
				...
				// This method is been called for skipping TPD Summary details when the check box is clicked.
				<#--<#if project?? && project.globalOutcomeEUShare?? && (project.globalOutcomeEUShare==1) && proposalInitiation?? && proposalInitiation.legalApprovalStatus?? && proposalInitiation.legalApprovalStatus == 1 >-->
				<#if proposalInitiation?? && proposalInitiation.legalApprovalStatus?? && proposalInitiation.legalApprovalStatus == 1 >
					enableProjectEvaluationCheckBoxTPDMain('no');
				</#if>	
...
<#-- ELSE BLOCK ENDS for Read Only Stage -->
...
<div id="initiateWaiver" style="display:none">
    <script type="text/javascript">
     ...
     <div class="">
        ...
        <form id="waiver-form" action="<@s.url value='/new-synchro/report-summary!updateWaiver.jspa'/>" method="post" class="j-form-popup">
...
<a href="javascript:void(0);" class="close" onclick="closeKantarWaiverWindow();"></a>
     <div class="">
        ...
        <form id="kantar-waiver-form" action="<@s.url value='/new-synchro/report-summary!updateKantarWaiver.jspa'/>" method="post">
		<div class="popup-title-overlay"></div>
...
<div id="pitWindow" style="display:none">
    <div class="view_edit_pib">
        ...
        <form id="synchro-pit-form" action="<@s.url value='/new-synchro/report-summary!updatePIT.jspa'/>" method="post" class="j-form-popup">
				...
				<#else>
					...
					<label>Cost Details</label>
						...
						<div id="agencyMain">
							...
							<select data-placeholder="Agency" title="Select Research Agency" disabled class="chosen-select  appended-agency researchAgency" id = "agency" name='agencies' >
				...
				<div class="region-inner">
					...
					<div class="form-text_div">
						...
						<#else>
							...
							<@macroCustomFieldErrors msg="Please enter the Proposal" class='textarea-error-message'/>
					</div>
						...
						<div class="form-select_div form-select_div_project_completion region-inner">
							...
							<div>
								...
								<#--	<select data-placeholder="Select Legal Approver"  class="chosen-select" id = "proposalLegalApprover" name='proposalLegalApprover' >
									...
									<span class="jive-error-message full-width" id="proposalLegalApproverError" style="display:none">Please select Proposal Legal Approver</span>
								<#else>
									<#if project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].GLOBAL_EU_OFFLINE.getId() || project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].END_MARKET_EU_OFFLINE.getId()>
										<#if proposalInitiation.getProposalLegalApproverOffline()??>
...
<form method="POST" name="cancelProj" id="cancelProj" action="/new-synchro/report-summary!cancelProject.jspa"  >
    <input type="hidden" name="projectID" value="${projectID?c}">
</form>


<form method="POST" name="enableProj" id="enableProj" action="/new-synchro/report-summary!enableProject.jspa"  >
    <input type="hidden" name="projectID" value="${projectID?c}">
</form>

<form method="POST" name="resetProposalForm" id="resetProposalForm" action="/new-synchro/report-summary!resetProposal.jspa"  >
    <input type="hidden" name="projectID" value="${projectID?c}">
</form>

<form method="POST" name="resetPIBForm" id="resetPIBForm" action="/new-synchro/report-summary!resetPIB.jspa"  >
    <input type="hidden" name="projectID" value="${projectID?c}">
</form>
...
/*function validatePIBFormFields()
{
	...
	if(legalSignOffRequired)
	{
		...
		$j("#legalSignOffReqValue").val('yes');
		var rsForm = jQuery("#report-summary-form");
		rsForm.submit();
	...
	else
	{
		...
		var reportType = $j("#reportType");
		
		if(reportType.val() != null && $j.trim(reportType.val())=="")
		{
			$j("#reportTyperError").show();
			error = true;
		}
		
		
		var reportTypeLegalApprover = $j("input[name=reportTypeLegalApprover]");
		var irisSummaryLegalApprover = $j("input[name=irisSummaryLegalApprover]");
		
		var tpdSummaryLegalApprover = $j("input[name=tpdSummaryLegalApprover]");
		
		if(reportTypeLegalApprover.val() != null && $j.trim(reportTypeLegalApprover.val())=="")
		{
			$j("#reportTypeLegalApproverError").show();
			error = true;
		}
		if(irisSummaryLegalApprover.val() != null && $j.trim(irisSummaryLegalApprover.val())=="")
		{
			$j("#irisSummaryLegalApproverError").show();
			error = true;
		}
		<#if project.processType?? && (project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].END_MARKET_NON_EU.getId() || project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].GLOBAL_NON_EU.getId())>
		<#else>
			if(tpdSummaryLegalApprover.val() != null && $j.trim(tpdSummaryLegalApprover.val())=="")
			{
				$j("#tpdSummaryLegalApproverError").show();
				error = true;
			}
			var tpdSummaryDate = $j("input[name=tpdSummaryDate]");
			if(tpdSummaryDate.val() != null && $j.trim(tpdSummaryDate.val())=="")
			{
				$j("#tpdSummaryDateError").show();
				error = true;
			}
		</#if>
...
function validatePIBFormFields()
{
	...
	/*	$j(".numericfield").each(function(){
       ...
       */
	     ...
	     var flag=enableProjectEvaluation();
...
function saveRSForm()
{
	...
	<#-- Adding check as part of http://redmine.nvish.com/redmine/issues/509 -->
	var legalSignOffRequired=$j("#legalsignoffreq").prop("checked");
	if(legalSignOffRequired)
	{
		$j("#legalSignOffReqValue").val('yes');
 ...
 function cancelProject()
  ...
  function resetPIB()
  {
	...
	$j("#mainTPDSummaryType").bind("click", function () {
		...
		$j(".report-summary-table").append(div);
	    $j('.new-report-type').chosen();
	...
	$j("#mainIrisSummaryType").bind("click", function () {
		...
		$j("body").on("click", "#expenseDetailsContainer .remove", function () {
	...
	function addMainReportType(value) 
	{
	     ...
	     var reportType  = "<div class='td dynamic-row' id='reportType'><select data-placeholder='Select Report Type'  class='chosen-select form-select new-report-type report-type-attach rt'    onchange='validateReportType()'     id='reportType' name='reportTypes'>"+$j('#reportType').clone(true).html()+"</select>  <span class='jive-error-message full-width' id='reportTypesErrors' style='display:none'>Please select Report Type</span></div>";
		 
	
		
		 
 		// var legalApprover = "<div class='td'>"+$j('#legalApproverDiv').clone(true).html()+"</div>";
		 var legalApprover = "<div class='td' id='legalApproverDiv'><input type='text'    placeholder= 'Enter Legal Approver's Name' name='reportTypeLegalApprovers' value=''  onchange='validateReportLegalApprovers()'  onfocus='this.placeholder = \"\"' onblur='this.placeholder = \"Enter Legal Approver's  Name\"'/>  <span class='jive-error-message full-width' id='reportTypeLegalApproverErrors' style='display:none'>Please enter Legal Approver's Name</span></div>";
		 //var attachmentDiv = "<div class='td'>"+$j('#attachmentDiv').clone(true).html();
		 var attachmentDiv = "<div class='td' id='attachmentDiv'><span class='jive-icon-med jive-icon-attachment j-link' onclick='showAttachmentPopupNewReport(${fullReportID?c},this,-1)' ></span>  <span class='jive-error-message full-width' id='attachmentError' style='display:none'>Please attach the Report</span>  ";
	...
	function addMainSummaryType(value){
		var summaryType  = "<div class='td dynamic-row'>IRIS Summary</div>";
		//var legalApprover = "<div class='td'>"+$j('#legalApproverDiv').clone(true).html()+"</div>";
		var legalApprover = "<div class='td'><input type='text'  onchange='validateIrisSummaryLegalApprovers()' placeholder= 'Enter Legal Approver's  Name' name='irisSummaryLegalApprovers' value=''   onfocus='this.placeholder = \"\"' onblur='this.placeholder = \"Enter Legal Approver's  Name\"'/> <span class='jive-error-message full-width' id='irisSummaryLegalApproverErrors' style='display:none'>Please enter Legal Approver's Name</span>  </div>";
		//var attachmentDiv = "<div class='td'>"+$j('#attachmentDiv').clone(true).html();
		var attachmentDiv = "<div class='td' id='attachmentDiv'><span class='jive-icon-med jive-icon-attachment j-link' onclick='showAttachmentPopupNew(${irisSummaryReportID?c},4,-1)' ></span><span class='jive-error-message full-width' id='attachmentError' style='display:none'>Please attach the IRIS Summary</span>";
		var removeLink = "<input type='button' value='Remove' class='removeRS' id='removeLink'>"+"</div>";
	...
	function addTPDSummaryType(value){
		var summaryType  = "<div class='td dynamic-row'>TPD Summary</div>";
		...
		var legalApprover = "<div class='td'><input type='text'  onchange='tpdSummaryLegalApproversValidation()' placeholder= 'Enter Legal Approver's  Name' name='tpdSummaryLegalApprovers' value=''  onfocus='this.placeholder = \"\"' onblur='this.placeholder = \"Enter Legal Approver's  Name\"'/> <span class='jive-error-message full-width' id='tpdSummaryLegalApproverErrors'  style='display:none' >Please enter Legal Approver's Name</span>  <input type='text' class='jive-form-textinput-variable j-form-datepicker' id='"+id+"' name='tpdSummaryDates' readonly='true' placeholder='Enter Date of Legal Approval'              onfocus='this.placeholder = \"\"' onblur='this.placeholder = \"Enter Date of Legal Approval\"'   onchange='dateSelected(this);'><a class='dynamic-date-btn' href='#' id='"+buttonId+"' onmouseover='dateClicked("+tpdReportTypecounter+")' onClick='dateClicked("+tpdReportTypecounter+")' class='j-form-datepicker-btn' ><img src='${themePath}/images/synchro/calendar.png' encode='false' width='19' height='19' border='0' /></a>  <span class='jive-error-message full-width' id='tpdSummaryDateErrors' style='display:none'>Please enter Legal Approver's Date</span> </div>";
		
	
		
		
		//var attachmentDiv = "<div class='td'>"+$j('#attachmentDiv').clone(true).html();
		var attachmentDiv = "<div class='td tpd' id='attachmentDiv'><span class='jive-icon-med jive-icon-attachment j-link' onclick='showAttachmentPopupNew(${tpdSummaryReportID?c},5,-1)' ></span></span><span class='jive-error-message full-width' id='attachmentError' style='display:none'>Please attach the TPD Summary</span>";
		var removeLink = "<input type='button' value='Remove' class='removeRS' id='removeLink'>"+"</div>";
		var content=  summaryType  +  legalApprover + attachmentDiv  + removeLink;
		//$j('#confirmProjectEnable').addClass("disabled");	
		return content;  
  ...
  function continueProject()
  {
	...
	if(legalSignOffRequired)
	{
		  ...
		  var flag=enableProjectEvaluationCheckBox('yes');
  ...
  $j("#legalsignoffreq").change(function() {
		...
		var reportTypeLegalApprover = $j("input[name=reportTypeLegalApprover]").val();
		  
		var irisSummaryLegalApprover = $j("input[name=irisSummaryLegalApprover]").val();
		var tpdSummaryLegalApprover = $j("input[name=tpdSummaryLegalApprover]").val();
		...
		$j('.rt').each(function() {
					var reportTypes = $j(this).val();
					
					if(reportTypes!=null && reportTypes!="" && reportTypes>-1)
					{
					$j(this).parent().find("#reportTypesErrors").hide();
					}
					else
					{
				$j(this).parent().find("#reportTypesErrors").hide();
...
/ * for 	reportTypeLegalApprover	  */
		if(reportTypeLegalApprover=="")
		 {$j("#reportTypeLegalApproverError").hide();
		...
		$j("input[name='reportTypeLegalApprovers']").each(function() {
					var reportTypeLegalApprovers = $j(this).val();
					 
					
					 if(reportTypeLegalApprovers=="")
					   {
					    $j(this).parent().find("#reportTypeLegalApproverErrors").hide();
					   }
					   else
					   {
					     $j(this).parent().find("#reportTypeLegalApproverErrors").hide();
		...
		/* for Iris Summary Legal Approver  */
		
		
		
		if(irisSummaryLegalApprover=="")
		 {
		$j("#irisSummaryLegalApproverError").hide();
		 }
		 else
		 {
		 $j("#irisSummaryLegalApproverError").hide();
		...
		$j("input[name='irisSummaryLegalApprovers']").each(function() {
					var irisSummaryLegalApprovers = $j(this).val();
					if(irisSummaryLegalApprovers!=null && irisSummaryLegalApprovers!="")
					{
					
					$j(this).parent().find("#irisSummaryLegalApproverErrors").hide();
					}
					else
					{
						$j(this).parent().find("#irisSummaryLegalApproverErrors").hide();
		...
		/* for TPD Summary Legal Approver  */
		  if(tpdSummaryLegalApprover=="")
		 {
		 ...
		 $j("input[name='tpdSummaryLegalApprovers']").each(function() {
					var tpdSummaryLegalApprovers = $j(this).val();
					if(tpdSummaryLegalApprovers!=null && tpdSummaryLegalApprovers!="")
					{
					
					$j(this).parent().find("#tpdSummaryLegalApproverErrors").hide();
					}
					else
					{
						$j(this).parent().find("#tpdSummaryLegalApproverErrors").hide();
		...
		/*    for TPD Summary Dates           */
	 var tpdSummaryDate = $j("#tpdSummaryDate").val();
            if(tpdSummaryDate!=null && tpdSummaryDate=="")			
			{
			
			$j("#tpdSummaryDateError").hide();
			}
			else
			{
			$j("#tpdSummaryDateError").hide();
	...
	$j("input[name='tpdSummaryDates']").each(function() {
					var tpdSummaryDates = $j(this).val();
					if(tpdSummaryDates!=null && tpdSummaryDates!="")
					{
					$j(this).parent().find("#tpdSummaryDateErrors").hide();
					}
					else
					{
		 ...
		 var counter=0;
		    $j('.report-summary-table .tr').each(function(){ 
	...
	/*function enableProjectEvaluation()
	{
		...
		if(reportType!=null && reportType!="" && reportType>-1 && reportTypeLegalApprover!=null && reportTypeLegalApprover!="" && irisSummaryLegalApprover!=null && irisSummaryLegalApprover!="" )
		{
			...
			<#if project.processType?? && (project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].END_MARKET_NON_EU.getId() || project.processType ==  statics['com.grail.synchro.SynchroGlobal$ProjectProcessType'].GLOBAL_NON_EU.getId()) && reportSummaryDetailsList?? && reportSummaryDetailsList?size gt 0 && hasReportAttachment=="yes" && hasIRISAttachment=="yes">
				$j("input[name='reportTypeLegalApprovers']").each(function() {
					...
					if(reportTypeLegalApprovers!=null && reportTypeLegalApprovers!="")
					{
					}
					else
					{
			...
			<#elseif  reportSummaryDetailsList?? && reportSummaryDetailsList?size gt 0 && hasReportAttachment=="yes" && hasIRISAttachment=="yes" && hasTPDAttachment=="yes">
				...
				if(tpdSummaryLegalApprover!=null && tpdSummaryLegalApprover!="" && tpdSummaryDate!=null && tpdSummaryDate!="" )
				{
					
					var blankReportTypeLegalApprovers="";
					$j("input[name='reportTypeLegalApprovers']").each(function() {
					var reportTypeLegalApprovers = $j(this).val();
					...
					{
						blankReportTypeLegalApprovers="yes";
					}
					
				}); 
				if(blankReportTypeLegalApprovers=="yes")
				{
					return true;
				}
				
				var blankReportTypes="";
				...
				$j('.rt').each(function() {
					...
					{
						blankReportTypes="yes";
					}
					
				}); 
				if(blankReportTypes=="yes")
				{
					return true;
				}
				
				var blankIrisSummaryLegalApprovers="";
				...
				$j("input[name='irisSummaryLegalApprovers']").each(function() {
					...
					{
						blankIrisSummaryLegalApprovers="yes";
					}
					
				});
				if(blankIrisSummaryLegalApprovers=="yes")
				{
					return true;
				}
				
				var blankTpdSummaryLegalApprovers="";
				...
				$j("input[name='tpdSummaryLegalApprovers']").each(function() {
					...
					{
						blankTpdSummaryLegalApprovers="yes";
					}
					
				});
				
				if(blankTpdSummaryLegalApprovers=="yes")
				{
					return true;
				}
				
				var blankTpdSummaryDates="";
				...
				$j("input[name='tpdSummaryDates']").each(function() {
					...
					{
						blankTpdSummaryDates="yes";
					}
					
				});
				
				if(blankTpdSummaryDates=="yes")
				{
					return true;
				}
	...
	function enableProjectEvaluation()
	{
		...
		$j('.rt').each(function() {
					...
					{
					$j(this).parent().find("#reportTypesErrors").show();
					flag=true;
...
/ * for 	reportTypeLegalApprover	  */
		...
		$j("input[name='reportTypeLegalApprovers']").each(function() {
					var reportTypeLegalApprovers = $j(this).val();
					 ...
					 if(reportTypeLegalApprovers=="")
					   {
					    $j(this).parent().find("#reportTypeLegalApproverErrors").show();
		...
		$j("input[name='irisSummaryLegalApprovers']").each(function() {
					...
					{
						$j(this).parent().find("#irisSummaryLegalApproverErrors").show();
						 flag=true;
		...
		/* for TPD Summary Legal Approver  */
		 ...
		 $j("input[name='tpdSummaryLegalApprovers']").each(function() {
					...
					{
						$j(this).parent().find("#tpdSummaryLegalApproverErrors").show();
						 flag=true;
	...
	$j("input[name='tpdSummaryDates']").each(function() {
					...
					{
					$j(this).parent().find("#tpdSummaryDateErrors").show();
		 ...
		 var counter=0;
 var total = $j('.report-summary-table .tr').length;
        
		 //  If TPD summary available
		 if(tpdSummaryDate=="undefined" || tpdSummaryDate==undefined)
		 {
		 
		 $j('.report-summary-table .tr').each(function(index) {
	 ...
	 $j("#reportType, #reportTypeLegalApprover, #irisSummaryLegalApprover, #tpdSummaryLegalApprover").change(function(){
		
		 if($j("#reportType").val()!="")
		{
		$j("#reportTyperError").hide();
		}
		if($j("#reportTypeLegalApprover").val()!="")
		{
		$j("#reportTypeLegalApproverError").hide();
		}
		
		
		if($j("#irisSummaryLegalApprover").val()!="")
		 {
		 $j("#irisSummaryLegalApproverError").hide();
		  ...
		  if($j("#tpdSummaryLegalApprover").val()!="")
		 {
		 $j("#tpdSummaryLegalApproverError").hide();
	...
	function validateReportLegalApprovers()
	{
	    $j("input[name='reportTypeLegalApprovers']").each(function() {
					var reportTypeLegalApprovers = $j(this).val();
	...
	function  validateIrisSummaryLegalApprovers()
	{
	...
	function  tpdSummaryLegalApproversValidation()
	{
	...
	function dateSelected(curr){
		currRow = $j(curr).parent().parent().find("#attachmentDiv").length;
		
		/*var error = enableProjectEvaluation();
			if(error)
			{
				//$j('#confirmProjectEnable').addClass("disabled");
			}
	...
	{
	<#--	FORM_DATA_PERSIST_HANDLER.handle({parentForm:$j("#report-summary-form"),form:$j("#report-summary-form"), projectID:${projectID?c}});-->
	...
	/*  Amit's Code  new change  */
	function enableProjectEvaluationCheckBox(showDialog)
	{
		...
		$j('.report-summary-table .tr').each(function(){ 
			...
			var at = $j(this).find('.jive-attach-item').length;
			if(at > 0){
		
			var a = $j(this).find('#reportType').val();
			var b = $j(this).find('#reportTypeLegalApprover').val();
			var c = $j(this).find('input[name="reportTypeLegalApprovers"]').val();
			
			var d = $j(this).find("input[name=irisSummaryLegalApprover]").val();
			var e = $j(this).find("input[name=irisSummaryLegalApprovers]").val();
			
			var f = $j(this).find("input[name=tpdSummaryLegalApprover]").val();
			var g = $j(this).find("#tpdSummaryDate").val();
			
			var h = $j(this).find("input[name=tpdSummaryLegalApprovers]").val();
			var i = $j(this).find("input[name=tpdSummaryDates]").val();
			
			
			if(a!=undefined && a!="undefined")
			{
				if(a!="" && ((b!=undefined && b!="undefined" && b!="") || (c!=undefined && c!="undefined" && c!="")))
				{
			...
			else if((d!=undefined && d!="undefined") )
			{
			...
			else if((f!=undefined && f!="undefined") )
			{
				
				if(f!="" && (g!=undefined && g!="undefined" && g!=""))
				{
					//alert(a);
				}
			...
			else if((h!=undefined && h!="undefined") )
			{
				
				if(h!="" && (i!=undefined && i!="undefined" && i!=""))
				{
					//alert(a);
				}
				...
				//alert("No Report Type Attachment");
			}
			
		});
		
		// if exception avialable 
		var tpdVisible= $j("#tpdSummaryLegalApprover").is(':visible');
		var tpdstatus=false;
		 if(tpdVisible)
		 {
	...
	$j("input[name='tpdSummaryDates']").each(function() {
		...
		//  check for tpd attachment....
		

		$j('.report-summary-table .tpd').each(function(){ 
		  ...
		  //alert("tpdstatus"+tpdstatus+ "error"+error);
			
			 if(tpdstatus==false && error==false)
			 {
		    ...
		    if(tpdstatus==false && error==true) 
			 {
				...
				dialog({
					title:"",
					html:"<p>Please make sure that attached report has the legal details filled.</p>",
					buttons:{
					"OK":function() {
						return false;		
					}
	...
	function enableProjectEvaluationCheckBoxTPDMain(showDialog)
	{
		
		var error = false;
		
		$j('.report-summary-table .tr').each(function(){ 
			//alert($j(this).find('select').val()); 
			//alert($j(this).find('input').val()); 
		...
		{
			enableProjectEvaluationCheckBoxTPD();
		}
		
		
	}
	
	function enableProjectEvaluationCheckBoxTPD()
	{
