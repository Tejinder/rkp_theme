...
<div class="container">
        ...
        <div class="project_dashboard_header">
			...
			<div class="report-menus" xmlns="http://www.w3.org/1999/html">
                <ul class="project_name_menu">
					...
					<li><a href="<@s.url value='/new-synchro/agency-waiver-pending-activities.jspa'/>" class="active">Agency Waivers</a></li>
                </ul>
            </div>
	...
	<form method="POST" name="waiverApprovalForm" id="waiverApprovalForm" action="/new-synchro/agency-waiver-pending-activities-pagination!approveAgencyWaiver.jspa"  >
		<input type="hidden" name="projectID" id="projectID" value="">
	</form>
	
<form method="POST" name="multiWaiverApprovalForm" id="multiWaiverApprovalForm" action="/new-synchro/agency-waiver-pending-activities-pagination!approveMultipleAgencyWaiver.jspa"  >
		<input type="hidden" name="multipleProjectIds" id="multipleProjectIds" value="">
	</form>
	
	<form method="POST" name="multiWaiverRejectForm" id="multiWaiverRejectForm" action="/new-synchro/agency-waiver-pending-activities-pagination!rejectMultipleAgencyWaiver.jspa"  >
		<input type="hidden" name="multipleRejectProjectIds" id="multipleRejectProjectIds" value="">
	</form>
	
	<form method="POST" name="updateWaiverForm" id="updateWaiverForm" action="/new-synchro/agency-waiver-pending-activities-pagination!updateWaiver.jspa"  >
...
function processPaginationRequest(page, keyword, plimit) {
  // alert("here");
	...
	var url = '/new-synchro/agency-waiver-pending-activities-pagination.jspa';
...
function processDownloadRequest(page, keyword, plimit) {
	...
	$j("#result-filter-form").prop("action", "/new-synchro/agency-waiver-pending-activities-pagination!downloadReport.jspa");
	var filterForm = $j("#result-filter-form");
...
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText>Pending Agency Waivers</#assign>
