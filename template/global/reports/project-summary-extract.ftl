...
<div class="container">
	...
	<div class="reports_dashboard_header">
       <h2>Generate Reports</h2>
		...
		<@overallReportsSubTab activeTab=1 />
        <div class="site_search">
			<h2>Project Summary Report</h2>				
            <form id="search-box">
                <input type="text" name="q" size="31" id="search_box" class="search_box"/>
	   ...
	   <div class="buttons">
		<a id="form_submit" href="javascript:void(0);"  onclick="javascript:extractProjectSummary();" class="continue">EXTRACT</a>
...
var cookie_name = "project-summary-extract";
...
{
	currPage = page;
	var url = '/synchro/reports-summary.jspa';
	if(xhr != null) 
		xhr.abort();
...
clearTimeout(timer);
 timer = setTimeout(function(){
	...
	function extractProjectSummary()
	{
	    ...
	    window.location.href = "/synchro/reports!extractReport.jspa?projectID="+projectID+"&token="+token+"&tokenCookie="+cookie_name;
    }
