...
<div class="container">
	...
	<div class="project-report">
		<@overallReportsSubTab activeTab=2 />        
		<div class="project-data-extract">
		<div class="report-heading">
			<h2>Project Fields</h2>            
        </div>
		<form id="project-data-extract" action="<@s.url value='project-data-extract.jspa' />" method="POST">
...
var cookie_name = "project-data-extract";
