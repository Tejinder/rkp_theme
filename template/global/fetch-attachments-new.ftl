...
<form method="POST" name="fetchAttachment" id="fetchAttachment" action="/new-synchro/migrate-projects!execute.jspa"  >
	...
	<input class="j-btn-callout" type="submit" name="Migrate Attachments" value="Migrate Projects" />
...
<script type="text/javascript">
    ...
    $j(document).ready(function(){
        attachmentWindow = new SYNCHRO_FIELD_ATTACHMENT_POPUP({
            formUrl:"<@s.url value='/new-synchro/migrate-projects!migrateProjectsBulk.jspa'/>",
