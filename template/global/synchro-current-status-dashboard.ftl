    ...
    <div class="project_view">
        <div class="project_dashboard_header">
           ...
           <div class="synchro-breadcrumb">
                ...
                <span class="separator">Project Status</span>
            </div>
...
<script type="text/javascript">
    ...
    {
        currPage = page;
        var url = '/synchro/current-status-dashboard-pagination.jspa';
        if(xhr != null)
            xhr.abort();
...
//                $j('body').css({height: docH});
	...
	function auditLogs()
	{	
		<#assign i18CustomStageText><@s.text name="logger.visibility.outside.project" /></#assign>
		<#assign i18CustomAdvSearchText><@s.text name="logger.project.pending.search.text" /></#assign>
		SynchroLogUtil.addLogActivity("${statics['com.grail.synchro.SynchroGlobal$PortalType'].SYNCHRO.getDescription()}", ${statics['com.grail.synchro.SynchroGlobal$PageType'].PROJECT.getId()}, ${statics['com.grail.synchro.SynchroGlobal$Activity'].VIEW.getId()}, 0, "${i18CustomStageText} - ${i18CustomAdvSearchText}", "", -1, ${user.ID?c});
	}
</script>
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText><@s.text name="logger.visibility.outside.project" /></#assign>
	SynchroLogUtil.addLogActivity("${statics['com.grail.synchro.SynchroGlobal$PortalType'].SYNCHRO.getDescription()}", ${statics['com.grail.synchro.SynchroGlobal$PageType'].PROJECT.getId()}, ${statics['com.grail.synchro.SynchroGlobal$Activity'].VIEW.getId()}, 0, "${i18CustomText}", "", -1, ${user.ID?c});
</script>