...
function confirmDelete(attachmentId, fieldID, attachmentName) {
    location.href="/new-synchro/project-close-fieldwork!removeAttachment.jspa?projectID=${projectID?c}&attachmentId="+attachmentId+"&attachmentFieldID="+fieldID+"&attachmentName="+attachmentName;
}
...
<div class="new-page-wrapper">
	...
	<li ><div class="nav-select">3</div><span>close</span></li>
	</ul>
	</div>
</div>
-->
...
<span><i>This project is now closed. </i></span> <a href="javascript:void(0);" onclick="javascript:openPITWindow()">Click here to view details.</a>
...
<script type="text/javascript">
    ...
    $j(document).ready(function(){
        attachmentWindow = new SYNCHRO_FIELD_ATTACHMENT_POPUP({
            formUrl:"<@s.url value='/new-synchro/project-close-fieldwork!addAttachment.jspa'/>",
            projectID:${projectID?c},
...
<div id="initiateWaiver" style="display:none">
   ...
   <div class="">
        ...
        <form id="waiver-form" action="<@s.url value='/new-synchro/project-close-fieldwork!updateWaiver.jspa'/>" method="post" class="j-form-popup">
...
<div id="initiateKantarWaiver" class="j-form-popup" style="display:none">
    ...
    <div class="">
        ...
        <form id="kantar-waiver-form" action="<@s.url value='/new-synchro/project-close-fieldwork!updateKantarWaiver.jspa'/>" method="post">
		<div class="popup-title-overlay"></div>
...
<div id="pitWindow" style="display:none">
    <div class="view_edit_pib">
        <form id="synchro-pit-form" action="<@s.url value='/new-synchro/project-close-fieldwork!updatePIT.jspa'/>" method="post" class="j-form-popup">
		   ...
		   <div class="pop-upinner-content">
			...
			<div class="region-inner">
				...
				<div class="region-inner">
					...
					<#if isAdminUser || isSynchroSystemOwner>
						<@renderBrandFieldNew name='brand' value=project.brand?default('-1') readonly=false/><span class="jive-error-message" id="brandError" style="display:none">Please select Brand</span>
					<#else>
			...
			<div class="region-inner">
				...
				<div class="region-inner">
				<#if isAdminUser || isSynchroSystemOwner>
					<@projectBudgetYearFieldNew name="budgetYear" value=project.budgetYear readonly=false/>
				<#else>
...
<form method="POST" name="cancelProj" id="cancelProj" action="/new-synchro/project-close-fieldwork!cancelProject.jspa"  >
    <input type="hidden" name="projectID" value="${projectID?c}">
</form>

<form method="POST" name="enableProj" id="enableProj" action="/new-synchro/project-close-fieldwork!enableProject.jspa"  >
    <input type="hidden" name="projectID" value="${projectID?c}">
</form>
...
$j("#brandSpecificStudy").change(function() {
   ...
   function enableProject()
  {
	...
	function addMainReportType(value) 
	{
		 ...
		 var attachmentDiv = "<div class='td' id='attachmentDiv'><span class='jive-icon-med jive-icon-attachment j-link' onclick='showAttachmentPopupNew(${fullReportID?c},1,"+mainReportTypecounter+")' ></span>";
