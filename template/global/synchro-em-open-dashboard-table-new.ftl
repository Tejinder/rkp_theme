...
<div>
	...
	<th class="catalogue-year sortable "><span id="projectStartDate">Project Start Date</span></th>
	<th class="catalogue-year sortable "><span id="projectManager">SP&I Contact</span></th>
    <th class="catalogue-year sortable "><span id="EndMarket">Research End market(s)</span></th>
    <th class="catalogue-year sortable "><span id="methodologydetails">Methodology</span></th>
    <th class="catalogue-year sortable "><span id="totalCost">Total Cost (GBP)</span></th>
	
	<th class="catalogue-year sortable "><span id="status">Project Stage</span></th>
	<th class="catalogue-year sortable "><span id="projectTrackStatus">Project Status</span></th>

        </thead>
        <tbody>
            <#list projects as project>
            <tr <#if (project_index % 2) == 0> class="last"</#if> >
                <td class="catalogue-code tpd_dashboard_projectName">
              
                    <span>${generateProjectCode('${project.projectID?c}')}</span>
                </td>
				<td class="catalogue-name tpd_dashboard_projectName">
                ...
                <td class="catalogue-year tpd_dashboard_projectName">
				 ...
				 <td class="catalogue-year tpd_dashboard_projectName">
					...
					<#if project.totalCost??>
						<span>${project.totalCost?round}</span>
					<#else>
						<span></span>
					</#if>	
				...
				<td class="catalogue-year tpd_dashboard_projectName">
					...
					<span>${project.projectTrackStatus}</span>
