...
<div class="container-sub">
    ...
    <div class="project_view">
		...
		<div class="dashboard-filter-links">
			...
			<a href="/new-synchro/regional-dashboard-close.jspa">Closed Projects</a>
...
//        $j("#ascendingOrder").val("");
    ...
    {
        currPage = page;
        var url = '/new-synchro/regional-dashboard-open-pagination.jspa'
        if(xhr != null)
            xhr.abort();
...
function processDownloadRequest(page, keyword, plimit, downloadReportType) {
	...
	$j("#result-filter-form").prop("action", "/new-synchro/regional-dashboard-open-pagination!downloadReport.jspa");
	var filterForm = $j("#result-filter-form");
...
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText>Regional Open Projects</#assign>
