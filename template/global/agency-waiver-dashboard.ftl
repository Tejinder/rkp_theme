        ...
        <div class="project_dashboard_header">
			...
			<div class="report-menus" xmlns="http://www.w3.org/1999/html">
                <ul class="project_name_menu">
					...
					<li><a href="<@s.url value='/new-synchro/agency-waiver-dashboard.jspa'/>" class="active">Agency Waivers</a></li>
                </ul>
            </div>
...
function processPaginationRequest(page, keyword, plimit) {
	...
	var url = '/new-synchro/agency-waiver-dashboard-pagination.jspa';
...
function processDownloadRequest(page, keyword, plimit, downloadReportType ) {
	...
	$j("#result-filter-form").prop("action", "/new-synchro/agency-waiver-dashboard-pagination!downloadReport.jspa");
	var filterForm = $j("#result-filter-form");
...
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText>Agency Waivers</#assign>
