        ...
        <div class="project_dashboard_header">
			...
			<div class="report-menus" xmlns="http://www.w3.org/1999/html">
                <ul class="project_name_menu">
                     <li><a href="<@s.url value='/new-synchro/process-waiver-dashboard.jspa'/>" class="active">Business Waivers</a></li>
                    <li><a href="<@s.url value='/new-synchro/methodology-waiver-dashboard.jspa'/>" >Methodology Waivers</a></li>
...
function processPaginationRequest(page, keyword, plimit) {
	...
	var url = '/new-synchro/process-waiver-dashboard-pagination.jspa';
...
function processDownloadRequest(page, keyword, plimit) {
	...
	$j("#result-filter-form").prop("action", "/new-synchro/process-waiver-dashboard-pagination!downloadReport.jspa");
	var filterForm = $j("#result-filter-form");
...
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText>Process Waivers</#assign>
