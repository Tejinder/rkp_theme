        ...
        <div class="project_dashboard_header">
           <#-- <div class="synchro-breadcrumb">
			...
			<div class="dashboard-filter-links">
				<a href="/new-synchro/em-dashboard-open.jspa" >Open Projects</a>
...
//        $j("#ascendingOrder").val("");
    ...
    function processPaginationRequest(page,keyword, plimit)
    {
		...
		currPage = page;
        var url = '/new-synchro/em-dashboard-pagination.jspa'
        if(xhr != null)
            xhr.abort();
...
function processDownloadRequest(page, keyword, plimit, downloadReportType) {
	...
	$j("#result-filter-form").prop("action", "/new-synchro/em-dashboard-pagination!downloadReport.jspa");
	var filterForm = $j("#result-filter-form");
...
<script type="text/javascript">
<!-- Audit Logs -->
	<#assign i18CustomText>End-market All Projects</#assign>
