        ...
        <div class="project_dashboard_header">
            ...
            <div class="report-menus" xmlns="http://www.w3.org/1999/html">
                <ul class="project_name_menu">
                    <li><a href="<@s.url value='/synchro/pending-activities.jspa'/>" class="active">Projects</a></li>
                    <li><a href="<@s.url value='/synchro/waiver-pending-activities.jspa'/>">Process Waivers</a></li>
                </ul>
            </div>
...
<script type="text/javascript">
    ...
    {
        currPage = page;
        var url = '/synchro/pending-activities-pagination.jspa';
        if(xhr != null)
            xhr.abort();
