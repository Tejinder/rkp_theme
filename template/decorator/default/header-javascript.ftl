...
<#if (!page?? || "false" != (page.getProperty("meta.includeHeaderScripts")!"true"))>
    <#include "/template/decorator/default/header-javascript-jquery.ftl" />
...
<#-- Common includes -->
    ...
    <@resource.javascript file="/resources/scripts/multifile.js"  header="true" id="core"/>
...
-->
    ...
    <#--<@resource.javascript file="/resources/scripts/apps/userpicker/views/userpicker_view.js" header="true" id="core" />-->
    ...
    <#--<@resource.javascript file="/resources/scripts/apps/userpicker/models/userpicker_source.js" header="true" id="core" />-->
