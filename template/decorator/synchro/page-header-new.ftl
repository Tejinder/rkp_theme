...
<#else>
	...
	<#elseif synchroURL?contains("/oracle/")>
    <a class="j-header-logo" title="Oracle Home" href="/oracle/home.jspa"></a>
	<#elseif synchroURL?contains("/share/")>
    <a class="j-header-logo" title="Share Home" href="/share/home.jspa"></a>
    <#else>
    <a class="j-header-logo" href="/new-synchro/home.jspa"></a>
    </#if>
    ...
    <div class="welcome">
	   ...
	   <#assign activityCountsData = 100/>
		...
		<li><div class="font-color-meta-light withmenu">Welcome, <a href="javascript:void(0);" data-username="${user.name}"  data-userid="${user.name}" class="jive-username-link   ">${user.name}</a><a title="Logout" href="/logout.jspa"><span id="j-satNav-logout" class="j-nav-logout"> </span></a></div></li>
